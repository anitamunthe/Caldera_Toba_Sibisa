                ...
                <div class="col-sm-12 col-md-4 order-sm-0 order-md-0 dcd-bg-gray py-5">
                    <div class="py-lg-5">
                        <img src="img/logo.jpg" alt="Caldera Toba" style="max-height: 207px;" width="150"
                            height="105">
                        <p class="mt-3" style="font-size: 15px;">Caldera Toba Sibisa<br>
                        ...
                        <dl>
                            {{-- <dd>
                                ...
                                <a href="https://www.instagram.com/bandrek_andaliman/?hl=id"
                                    class="social-media-link p-1 p-md-0 mr-2 text-muted" target="_blank"
                                    rel="noopener"><svg width="20" height="20" viewBox="0 0 448 512"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill="currentColor"
                                ...
                                <a href="https://www.youtube.com/watch?v=yUGt1u5MIqU&list=PLB6B1Nm3HGWJ_yTZTZZA9NpAFmKFsaK27"
                                    class="social-media-link p-1 p-md-0 mr-2 text-muted" target="_blank"
                                    rel="noopener"><svg width="20" height="20" viewBox="0 0 576 512"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill="currentColor"
