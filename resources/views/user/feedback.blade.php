    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
              <div class="card">
                <div class="card-body">
                  <img src="productimage/{{ $feedback->barangs->gambar }}" width="300px" alt="productimage/{{ $feedback->barangs->gambar }}">
                </div>
              </div>
            </div>
            <div class="col-sm-6">
                  ...
                  <form action="{{ url('/berikan-ulasan-process/'.$feedback->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-6" style="position:relative">
                        ...
                        <input type="file" id="firstimg" name="img2" style="display:none;visibility:none;" onchange="getImage(this.value)" class="form-control" /><br>
                        <div id="display-image"></div>
                      </div>
                      <div class="col-6" style="position:relative">
                        <label for="firstvideo"><i class="fas fa-video text-center text-primary" style="font-size: 24px; border:1px solid rgb(30, 27, 238); padding:10px 65px 40px 65px; cursor: pointer; "><p style="color: blue; position:absolute; bottom:-10px; left:20%; font-size:12px; font-family:'Times New Roman', Times, serif">Tambah Video</p></i></label>
                        <input type="file" id="firstvideo" name="video" style="display:none;visibility:none;" onchange="getImage(this.value)" class="form-control" /><br>
